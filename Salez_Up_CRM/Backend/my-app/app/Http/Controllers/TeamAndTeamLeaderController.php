...
class TeamAndTeamLeaderController extends Controller
{
    ...
    {
        return TeamAndTeamLeader::with(['team.CampaignsAndTeams.campaign', 'teamLeader'])->get();
    }
...
{
    $teamAndTeamLeader = TeamAndTeamLeader::with(['teamLeader', 'team.CampaignsAndTeams.campaign'])
